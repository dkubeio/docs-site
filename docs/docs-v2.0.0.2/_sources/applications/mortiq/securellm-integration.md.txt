...
This guide explains how to integrate and configure SecureLLM as a local inference provider in MortIQ.
...
Navigate to **Settings** in the MortIQ UI and configure:
...
MortIQ automatically discovers available models from the SecureLLM gateway at runtime. This means:
...
MortIQ tracks token usage for all providers including SecureLLM:
...
For MortIQ integration issues:
- Check logs: `tail -f logs/mortiq.log`
