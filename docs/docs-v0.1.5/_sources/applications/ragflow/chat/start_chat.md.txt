...
3. Update Prompt-specific settings:
   ...
   - **Rerank model** sets the reranker model to use. It is left empty by default.
     ...
     - If **Rerank model** is selected, the hybrid score system uses keyword similarity and reranker score, and the default weight assigned to the reranker score is 1-0.7=0.3.
   - [Cross-language search](https://github.com/infiniflow/ragflow/blob/main/docs/references/glossary.mdx#cross-language-search): Optional  
   ...
   - **Variable** refers to the variables (keys) to be used in the system prompt. `{knowledge}` is a reserved variable. Click **Add** to add more variables for the system prompt.
      ...
      - As of v0.17.2, if you add custom variables here, the only way you can pass in their values is to call:
         - HTTP method [Converse with chat assistant](https://github.com/infiniflow/ragflow/blob/main/docs/references/http_api_reference.md#converse-with-chat-assistant), or
         - Python method [Converse with chat assistant](https://github.com/infiniflow/ragflow/blob/main/docs/references/python_api_reference.md#converse-with-chat-assistant).
...
1. Before proceeding, you must [acquire an API key](https://github.com/infiniflow/ragflow/blob/main/docs/develop/acquire_ragflow_api_key.md); otherwise, an error message would appear.
