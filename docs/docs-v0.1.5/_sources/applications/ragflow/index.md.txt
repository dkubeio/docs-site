...
```{toctree}
:maxdepth: 2
:caption: RAGFlow Docs

self
ai_search
manage_files
basics/rag
basics/agent_context_engine
models/llm_api_key_setup
chat/start_chat
chat/implement_deep_research
chat/set_chat_variables
dataset/configure_knowledge_base
dataset/run_retrieval_test
dataset/use_tag_sets
dataset/enable_excel2html
dataset/set_page_rank
dataset/set_metadata
dataset/manage_metadata
dataset/configure_child_chunking_strategy
dataset/set_context_window
dataset/select_pdf_parser
dataset/advanced/construct_knowledge_graph
dataset/advanced/enable_raptor
dataset/advanced/extract_table_of_contents
dataset/advanced/auto_metadata
dataset/add_data_source/add_google_drive
agent/agent_introduction
agent/embed_agent_into_webpage
agent/best_practices/accelerate_agent_question_answering
agent/agent_quickstarts/build_ecommerce_customer_support_agent
agent/agent_quickstarts/ingestion_pipeline_quickstart
agent/agent_quickstarts/sandbox_quickstart
agent/agent_component_reference/begin
agent/agent_component_reference/chunker_title
agent/agent_component_reference/chunker_token
agent/agent_component_reference/docs_generator
agent/agent_component_reference/execute_sql
agent/agent_component_reference/http
agent/agent_component_reference/indexer
agent/agent_component_reference/message
agent/agent_component_reference/parser
agent/agent_component_reference/transformer
administrator/configurations
administrator/backup_and_migration
administrator/admin/admin_service
administrator/admin/admin_ui
administrator/admin/ragflow_cli
memory/use_memory
team/manage_team_members
team/join_or_leave_team
team/share_knowledge_bases
team/share_chat_assistant
team/share_agents
team/share_model
team/share_memory
```
...
If you are on an ARM platform, follow [this guide](https://github.com/infiniflow/ragflow/blob/main/docs/develop/build_docker_image.mdx) to build a RAGFlow Docker image.
:::
...
1. Ensure `vm.max_map_count` >= 262144.
   ...
   `vm.max_map_count` sets the maximum number of memory map areas a process may have. Its default value is 65530. RAGFlow v0.24.0 uses Elasticsearch or [Infinity](https://github.com/infiniflow/infinity) for multiple recall. Setting this value correctly is crucial to the proper functioning of the Elasticsearch component.
   ...
   **Windows (Docker Desktop WSL 2):**
   ...
   To make it permanent on Windows, update `%USERPROFILE%\.wslconfig`:
...
- [Acquire a RAGFlow API key](https://github.com/infiniflow/ragflow/blob/main/docs/develop/acquire_ragflow_api_key.md)
- [HTTP API reference](https://github.com/infiniflow/ragflow/blob/main/docs/references/http_api_reference.md)
- [Python API reference](https://github.com/infiniflow/ragflow/blob/main/docs/references/python_api_reference.md)
:::
