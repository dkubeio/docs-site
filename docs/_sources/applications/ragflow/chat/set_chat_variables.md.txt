...
The *only* way to pass in values for the custom variables defined in the **Chat Configuration** dialogue is to call RAGFlow's [HTTP API](https://github.com/infiniflow/ragflow/blob/main/docs/references/http_api_reference.md#converse-with-chat-assistant) or through its [Python SDK](https://github.com/infiniflow/ragflow/blob/main/docs/references/python_api_reference.md#converse-with-chat-assistant).

### HTTP API

See [Converse with chat assistant](https://github.com/infiniflow/ragflow/blob/main/docs/references/http_api_reference.md#converse-with-chat-assistant). Here's an example:
...
See [Converse with chat assistant](https://github.com/infiniflow/ragflow/blob/main/docs/references/python_api_reference.md#converse-with-chat-assistant). Here's an example:
