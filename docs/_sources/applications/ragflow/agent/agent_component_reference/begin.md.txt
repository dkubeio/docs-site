...
- HTTP method [Converse with agent](https://github.com/infiniflow/ragflow/blob/main/docs/references/http_api_reference.md#converse-with-agent), or
- Python method [Converse with agent](https://github.com/infiniflow/ragflow/blob/main/docs/references/python_api_reference.md#converse-with-agent).
  :::
