...
This document describes the system architecture, design principles, and component interactions of MortIQ.

## System Overview

MortIQ is a multi-agent AI system designed for automated mortgage underwriting with privacy-first principles. The architecture separates concerns into distinct processing zones based on data sensitivity.
...
MortIQ supports three distinct pipelines, each optimized for specific workflows:
